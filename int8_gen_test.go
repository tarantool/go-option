...
func ExampleInt8_MustGet() {
	some := option.SomeInt8(12)
	fmt.Println(some.MustGet())
	// Output: 12
}

func ExampleInt8_MustGet_panic() {
	none := option.NoneInt8()
	eof := false
	defer func() {
		if !eof {
